...
class DriveAPI:
    ...
    Handels OAuth connection, file browsing, meta data retrieval,
    ...
    def __init__(
        ...
        """Initializes DriveAPI class for accessing google drive.

        Args:
            credentials_path (Union[str, PathLike], optional): Path to credentials to
                google drive. Defaults to SECRETS_PATH/"credentials.json".
    ...
    def file_upload(self, file_path: str, save_name: Optional[str] = None) -> bool:
        ...
        Raises an error if upload fails.
        Filename is taken from the filename.
    ...
    def is_mimetype(self, file_id: str, target_mime_type: str) -> bool:
        ...
        Returns:
            bool: True, iff the mime type of the given
                file matches the target mime
